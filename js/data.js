...
const MENUS = [
    { id: 'dashboard', label: 'Dashboard', icon: 'fa-tachometer-alt', children: [] },
    ...
    { 
        ...
        children: [
            { id: 'prog-mts', label: 'Program Bulanan MTS' },
            { id: 'prog-smk', label: 'Program Bulanan SMK' }
        ]
    },
    ...
    { 
        ...
        children: [
            { id: 'absensi-mts', label: 'Absensi Siswa MTS' },
            { id: 'absensi-smk', label: 'Absensi Siswa SMK' },
            { id: 'absensi-guru', label: 'Absensi Guru' },
            { id: 'rekap-absensi', label: 'Rekap Absensi' }
        ]
    },
    ...
    { 
        ...
        icon: 'fa-file-alt', 
        children: [
            { id: 'surat-izin', label: 'Surat Izin Guru/Staff' },
            { id: 'laporan-wali', label: 'Lap. Mingguan Wali Murid' },
            { id: 'laporan-umum', label: 'Laporan Umum' }
        ]
    }
];